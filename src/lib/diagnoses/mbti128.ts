...
export const mbti128Diagnosis: DiagnosisConfig = {
  ...
  questions: [
    ...
    },
    {
      ...
      sectionName: '情報の取り方',
      emoji: '🌌',
      text: 'バズる投稿や流行には、裏にある法則やパターンがあると思う',
    ...
    },
    {
      ...
      sectionName: '情報の取り方',
      emoji: '🌅',
      text: '映える写真を撮るより、その場の雰囲気を自分の目で楽しみたい',
    ...
    },
    {
      ...
      sectionName: '判断の仕方',
      emoji: '🤝',
      text: 'SNSで辛い投稿を見ると、自分まで気持ちが沈んでしまう',
    ...
    },
    {
      ...
      sectionName: '感情表現',
      emoji: '🧊',
      text: '炎上やトラブルがあっても、感情的にならず冷静でいられる',
    ...
    },
    {
      ...
      sectionName: '社会的態度',
      emoji: '🗡️',
      text: 'みんなが「いいね」していても、自分が違うと思ったら反対意見を言える',
    ...
    },
    {
      ...
      sectionName: '変化への対応',
      emoji: '🔁',
      text: 'アプリのアップデートや仕様変更が続くとストレスを感じる',
